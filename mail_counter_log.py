...
def mail_err_log():
    ...
    try:
        ...
        zipfile.ZipFile('counter.zip', mode='w').write('counter.log', compress_type=zipfile.ZIP_DEFLATED)
    ...
    try:
        if os.path.isfile(log_file):
            ...
            cmd = 'mpack -s "Bliley Counter log file" {} {}'.format(zip_file, mail_address)
            print("mail_counter_log cmd : {}".format(cmd))
...
def main():
    print("Mail Bliley Counter logs: log Version {}".format(VERSION))
    mail_err_log()
